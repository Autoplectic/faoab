...
\newcommand{\himc}{\ensuremath{h_{imc}}\xspace}
\newcommand{\pee}{\ensuremath{pee}\xspace}
...
\newcommand{\Present}{\ensuremath{\MeasSymbol_0}\xspace}
\renewcommand{\Future}{\MeasSymbols{1}{}}

\newcommand{\FCS}{\CausalState^\forward}
\newcommand{\RCS}{\CausalState^\reverse}
